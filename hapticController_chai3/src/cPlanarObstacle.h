...
class cPlanarObstacle : public cMesh
{
    public:
        cPlanarObstacle(cWorld* a_world, double a_height,
                const std::vector<cVector3d> a_points = std::vector<cVector3d>());
        virtual ~cPlanarObstacle();

        void setPoints(std::vector<cVector3d> a_points);
        ...
        // the std::vector pointing "into the obstacle" for the viscous trap
